...
class ReservationsAPI:
    ...
    def create_rental_reservation(self, data: NewRentalRequest = None, *,     allow_back_order_reservations: bool = None, always_on: bool = None, area_code_select_option: List[str] = None, duration: RentalDuration = None, is_renewable: bool = None,
        number_type: NumberType = None,
        billing_cycle_id_to_assign_to: str = None,
        service_name: str = None,
        capability: ReservationCapability = None) -> ReservationSaleExpanded:
        """Creates a new sale"""
        data = NewRentalRequest(
            allow_back_order_reservations=allow_back_order_reservations if allow_back_order_reservations is not None else data.allow_back_order_reservations,
    ...
    def get_rental_pricing(self, data: Union[NewRentalRequest, RentalPriceCheckRequest] = None, *,
        service_name: str = None,
        area_code: bool = None,
        number_type: NumberType = None,
        ...
        duration: RentalDuration = None) -> PricingSnapshot:
        """Get rental pricing."""
        ...
        data = RentalPriceCheckRequest(
            ...
            is_renewable=is_renewable if is_renewable is not None else data.is_renewable,
            duration=duration or data.duration
        ) if data else RentalPriceCheckRequest(
            service_name=service_name,
            area_code=area_code,
            number_type=number_type,
            capability=capability,
        ...
        if not data or data.service_name is None or data.area_code is None or data.number_type is None or data.capability is None or data.always_on is None or data.is_renewable is None or data.duration is None:
            raise ValueError("All required fields must be provided: service_name, area_code, number_type, capability, always_on, is_renewable, duration.")
    ...
    def get_backorder_reservation(self, reservation_id: Union[str, BackOrderReservationCompact, BackOrderReservationExpanded]) -> BackOrderReservationExpanded:
        """Get backorder reservations."""
        reservation_id = reservation_id.id if isinstance(reservation_id, (BackOrderReservationCompact, BackOrderReservationExpanded)) else reservation_id
    ...
    def get_renewable_reservations(self) -> PaginatedList[RenewableRentalCompact]:
        ...
        return PaginatedList(
            ...
            parse_item=RenewableRentalCompact.from_api,
    ...
    def get_renewable_reservation_details(self, reservation_id: Union[str, RenewableRentalCompact, RenewableRentalExpanded]) -> RenewableRentalExpanded:
    ...
    def refund_renewable_reservation(self, reservation_id: Union[str, RenewableRentalCompact, RenewableRentalExpanded]) -> bool:
    ...
    def renew_overdue_renewable_reservation(self, reservation_id: Union[str, RenewableRentalCompact, RenewableRentalExpanded]) -> bool:
